...
<!-- Carrosel vai até aqui -->
        ...
        <section class="cursos">
            <div class="conteiner">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            ...
                            <img src="imgs/idvisual.png" alt="Identidade Visual">
                        </div>
                    </div>
                <div class="col">
                    <div class="card">
                ...
                <div class="col">
                    <div class="card">
                        <p>Conteúdo gravado e material exclusivo</p>
                        <img src="imgs/conteudogravado.png" alt="Conteúdo Gravado">
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        <p>Arte Autoral</p>
                        <img src="imgs/arteautoral.png" alt="Arte autoral">
                </div>
            </div>
